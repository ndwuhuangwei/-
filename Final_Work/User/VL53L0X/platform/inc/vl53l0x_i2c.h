...
//////////////////////////////////////////////////////////////////////////////////
//IO方向设置  3   左前方P10接口
#define VL_SDA_IN()  {GPIOA->CRL&=0xF0FFFFFF;GPIOA->CRL|=0x08000000;}
#define VL_SDA_OUT() {GPIOA->CRL&=0xF0FFFFFF;GPIOA->CRL|=0x03000000;} 
//IO操作函数
#define VL_IIC_SCL    PAout(7)    //SCL
#define VL_IIC_SDA    PAout(6) 		//SDA
#define VL_READ_SDA   PAin(6) 		//输入SDA
