...
static void LCD_Gpio_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOG, ENABLE);	 //使能PB,PG端口时钟
    ...
    /*
    	...
    	LCD_CS:		PG7
    */
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6 |GPIO_Pin_7|GPIO_Pin_8;//PG6.7.8	端口配置
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;		 //IO口速度为50MHz
	GPIO_Init(GPIOG, &GPIO_InitStructure);					 //根据设定参数初始化
	GPIO_SetBits(GPIOG,GPIO_Pin_6 |GPIO_Pin_7|GPIO_Pin_8);	 //PG6.7.8 输出高

	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_14;	//PB14 端口配置
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;		 //IO口速度为50MHz
